...
### H
  ...
  * **[HarfBuzz (libharfbuzz.so) 14.3.0](harfbuzz.md)<a id='harfbuzz'></a>**<br>
...
### N
  ...
  * **[neon: libneon (libneon.so) 0.30.2/0.37.0](neon.md)<a id='neon'></a>**<br>
...
### O
  ...
  * **[openjp2: libopenjp2 (libopenjp2.so) 2.5.4](openjp2.md)<a id='openjp2'></a>**<br>
...
### U
  ...
  * **[uClibc (ld-uClibc-x.y.z.so) 0.9.28/0.9.29/0.9.32.1/0.9.33.2/1.0.14/1.0.59](uclibc.md)<a id='uclibc'></a>**<br>
...
### Z
  ...
  * **[Zlib (libz.so) 1.3.2](zlib.md)<a id='zlib'></a>**<br>
